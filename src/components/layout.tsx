  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="Network Buddy"
          content="Network Buddy is a personalized CRM system to help young adults create and maintain relationships in both their professional and personal lives."
        />
        <meta
          name="viewport"
